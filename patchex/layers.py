"""Transformer layers for the patch encoder.

Derived from PatchTST (Nie et al., ICLR 2023, github.com/yuqinie98/PatchTST),
which PatchET (Qiu et al.) adapted for protein patches. Vendored here unchanged
in behaviour so that PatchET/PatchEX checkpoints load without an external
